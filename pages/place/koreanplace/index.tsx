...
export default function KoreanPlace({ initialPosts }: { initialPosts: Post[] }): JSX.Element {
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  await queryClient.prefetchQuery(['posts', 'all', '한식', order], () => fetchPosts('한식', order));

  const initialPosts = queryClient.getQueryData<Post[]>(['posts', 'all', '한식', order]);
