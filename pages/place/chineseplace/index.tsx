...
//   await queryClient.prefetchQuery(['posts', 'all', '중식', order], () => fetchPosts('중식', order));
...
export default function ChinesePlace({ initialPosts }: { initialPosts: Post[] }): JSX.Element {
  const router = useRouter();
  const [order, setOrder] = useState<OrdKey>((router.query.sort as OrdKey) || 'commentscount');
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const initialPosts = queryClient.getQueryData<Post[]>(['posts', 'all', '중식', order]);
